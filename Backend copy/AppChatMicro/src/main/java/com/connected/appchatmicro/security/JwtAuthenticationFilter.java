 ...
 * ServletException, IOException { String jwt = getJwtFromRequest(request);
 * 
 * if (StringUtils.hasText(jwt) && jwtProvider.validateToken(jwt)) { String
 ...
 * return bearerToken.substring(7); } return bearerToken; } }
 */