...
//	void deletePostByAdvertiserEmailAndDate(String advertiserEmail, LocalDate postDate);
	...
	void addComment(String senderEmail, String receiverEmail, Long postId, String commentText);

	
	void deleteCommentByReceiverEmailAndCommentId(String receiverEmail, Long commentId);

	void deleteCommentBySenderEmailAndCommentId(String senderEmail, Long commentId);

	List<AdvertiserComment> getCommentsByPostId(Long postId);

	void deleteAdvertisementPostById(Long postId);
