...
//    }
    ...
    public ResponseEntity<?> createAdvertisementPost(
        ...
        try {
            ...
            AdvertisementPost createdPost = advertisementService.createAdvertisementPost(email,caption,link, imageBytes);
    ...
    public ResponseEntity<?> addCommentToPost(
        ...
        try {
            ...
            AdvertisementPost updatedPost = advertisementService.addCommentToPost(senderEmail, receiverEmail, date, comment);
