...
public interface AdvertisementService {
	 ...
	 List<AdvertisementPost> getAllPosts();
	    ...
	    AdvertisementPost createAdvertisementPost(String email, String caption,String link, byte[] image);
		...
		AdvertisementPost addCommentToPost(String senderEmail, String receiverEmail, LocalDate postDate, String comment);
	}
